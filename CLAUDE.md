...
The action installs OpenCode, detects features affected by the PR diff (AI-inferred), runs `/test-feature` for each, and posts results as a PR comment with full reports as downloadable artifacts.
